...
d3.json("/raw-web-api", function (myData) { 
    ...
    var all_dict = {
        "Grayall": gray_approach_count/(gray_approach_count+gray_n_approach_count),
        "Cinnamonall": cinnamon_approach_count/(cinnamon_approach_count+cinnamon_n_approach_count),
        "Blackall": black_approach_count/(black_approach_count+black_n_approach_count)
    };
    ...
    var yLinearScale2 = d3.scaleLinear()
        .domain([0, d3.max(all_array, d => d.value + 10)])
        .range([height2, 0]);
